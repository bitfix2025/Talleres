...
export default function InventarioPage() {
  ...
  const estadisticas = useMemo(() => {
    const unidades = productos.reduce(
      (total, producto) => total + producto.stock_actual,
      0
    );
    ...
    const valor = productos.reduce(
      (total, producto) =>
        total + producto.stock_actual * producto.costo,
      0
    );
  ...
  const guardarProducto = async (
    ...
    /*
     * Si se crea un producto con stock inicial,
     * también dejamos registrado el movimiento inicial.
     *
     * Las entradas posteriores de mercadería se gestionarán
     * desde Compras → Recepción de compra.
     */
    if (stock > 0) {
    ...
    setProductos((actuales) =>
      [...actuales, data as Producto].sort((a, b) =>
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 lg:py-8">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-500">
              Repuestos, componentes y accesorios del taller.
            </p>
          </div>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          <StatCard
            ...
            label="Productos"
            value={String(estadisticas.productos)}
          />

          <StatCard
            icon={<Boxes size={19} />}
            label="Unidades"
            value={String(estadisticas.unidades)}
          />

          <StatCard
            icon={<AlertTriangle size={19} />}
            label="Stock bajo"
            value={String(estadisticas.bajos)}
          />

          <StatCard
            icon={<DollarSign size={19} />}
            label="Valor del inventario"
            value={moneda(estadisticas.valor)}
          />
        </div>
          ...
          {cargando ? (
            ...
            <div className="flex min-h-[300px] flex-col items-center justify-center px-6 text-center">
              ...
              <p className="mt-1 max-w-sm text-xs leading-5 text-gray-400">
                Agregá el primer repuesto para comenzar a controlar el stock del taller.
              </p>
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="mt-3 flex items-center justify-between">
                          ...
                          <span
                            className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[10px] font-bold ${estado.clase}`}
                          >
                            <span
                        ...
                        {/* SIN ENTRADA / SALIDA */}
                        <div className="mt-4 rounded-xl bg-[#f8faf9] px-3 py-2.5 text-center">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-400">
                    JPG, PNG o WEBP. Recomendado: foto clara del repuesto.
                  </p>
                </div>
              </div>
